...
export default async function Home() {
  ...
  return (
    <main className="relative flex w-full flex-1 flex-col items-center justify-center overflow-hidden px-4 py-20 text-center">
      ...
      <span className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-400 text-2xl font-bold text-slate-900 shadow-sm">
        V
      </span>
      ...
      <Link
        ...
        className="mt-8 rounded-lg bg-amber-400 px-6 py-2.5 text-sm font-semibold text-slate-900 shadow-sm transition-colors hover:bg-amber-300"
      >
